...
export default function ProfileScreen() {
  ...
  // This route owns a native stack header, so the navigator has already
  // consumed the top safe area. Adding `insets.top` again creates a large,
  // device-dependent blank band under the title.
  const topPadding = 12;
