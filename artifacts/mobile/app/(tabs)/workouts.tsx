    ...
    return (
      <View style={[styles.empty, { backgroundColor: theme.background, paddingTop: topPadding }]}>
        ...
        <OptionCard
          icon="add-circle"
          title="Log Workout"
          description="Start an empty workout. Add exercises and log sets one by one as you go."
        ...
        <OptionCard
          ...
          description="Proven programmes built on established training principles. Free on every plan."
          accent={Colors.accentGreen}
          onPress={() => {
        ...
        <OptionCard
          ...
          title="Custom Self Tracking"
          description="Build your own workout plan. Choose exercises, sets, and reps. Track your progress manually."
          accent={Semantic.manual}
          onPress={() => {
        ...
        <OptionCard
          ...
          description="Get a personalized plan generated by AI based on your goals, equipment, and fitness level."
          emphasised
          locked={!canAccess("ai_workout")}
          onPress={() => {
