...
const foodDatabase: Record<string, FoodItem[]> = {
  breakfast: [
    ...
    { name: "Idli with sambar", calories: 220, protein: 8, carbs: 40, fats: 3, servingSize: "4 idli + sambar", types: ["vegetarian", "vegan", "eggetarian", "non_vegetarian"] },
    { name: "Poha with peanuts", calories: 260, protein: 7, carbs: 42, fats: 7, servingSize: "1 bowl", types: ["vegetarian", "eggetarian", "non_vegetarian"] },
    { name: "Upma", calories: 280, protein: 7, carbs: 42, fats: 8, servingSize: "1 bowl", types: ["vegetarian", "eggetarian", "non_vegetarian"] },
    { name: "Aloo paratha with curd", calories: 380, protein: 10, carbs: 52, fats: 14, servingSize: "2 parathas", types: ["vegetarian", "eggetarian", "non_vegetarian"] },
    { name: "Masala dosa", calories: 310, protein: 8, carbs: 46, fats: 10, servingSize: "1 dosa", types: ["vegetarian", "eggetarian", "non_vegetarian"] },
    { name: "Shakshuka", calories: 290, protein: 18, carbs: 18, fats: 16, servingSize: "1 serving", types: ["eggetarian", "non_vegetarian"] },
    { name: "Banana smoothie bowl", calories: 300, protein: 10, carbs: 52, fats: 7, servingSize: "1 bowl", types: ["vegetarian", "vegan", "eggetarian", "non_vegetarian"] },
    { name: "Pesarattu (green moong dosa)", calories: 220, protein: 12, carbs: 32, fats: 5, servingSize: "2 pieces", types: ["vegetarian", "vegan", "eggetarian", "non_vegetarian"] },
    { name: "Overnight oats", calories: 340, protein: 12, carbs: 56, fats: 8, servingSize: "1 jar", types: ["vegetarian", "eggetarian", "non_vegetarian"] },
    { name: "Pongal with coconut chutney", calories: 310, protein: 9, carbs: 50, fats: 8, servingSize: "1 bowl", types: ["vegetarian", "eggetarian", "non_vegetarian"] },
    { name: "Uttapam with vegetables", calories: 280, protein: 8, carbs: 42, fats: 8, servingSize: "2 pieces", types: ["vegetarian", "eggetarian", "non_vegetarian"] },
    { name: "Egg bhurji with roti", calories: 350, protein: 20, carbs: 32, fats: 14, servingSize: "2 rotis + bhurji", types: ["eggetarian", "non_vegetarian"] },
  ],
  lunch: [
    ...
    { name: "Paneer tikka rice bowl", calories: 410, protein: 22, carbs: 45, fats: 14, servingSize: "1 bowl", types: ["vegetarian", "eggetarian", "non_vegetarian"] },
    { name: "Tofu stir-fry", calories: 350, protein: 20, carbs: 38, fats: 12, servingSize: "1 serving", types: ["vegetarian", "vegan", "eggetarian", "non_vegetarian"] },
    ...
    { name: "Dal makhani & jeera rice", calories: 450, protein: 18, carbs: 64, fats: 12, servingSize: "1 plate", types: ["vegetarian", "eggetarian", "non_vegetarian"] },
    { name: "Rajma chawal", calories: 420, protein: 16, carbs: 72, fats: 6, servingSize: "1 plate", types: ["vegetarian", "vegan", "eggetarian", "non_vegetarian"] },
    { name: "Butter chicken & naan", calories: 560, protein: 30, carbs: 62, fats: 22, servingSize: "1 plate", types: ["non_vegetarian"] },
    { name: "Chole bhature", calories: 480, protein: 16, carbs: 65, fats: 18, servingSize: "1 plate", types: ["vegetarian", "eggetarian", "non_vegetarian"] },
    { name: "Veg biryani", calories: 390, protein: 10, carbs: 64, fats: 10, servingSize: "1 plate", types: ["vegetarian", "eggetarian", "non_vegetarian"] },
    { name: "Chicken biryani", calories: 450, protein: 24, carbs: 58, fats: 12, servingSize: "1 plate", types: ["non_vegetarian"] },
    { name: "Chicken shawarma wrap", calories: 420, protein: 30, carbs: 35, fats: 16, servingSize: "1 wrap", types: ["non_vegetarian"] },
    { name: "Falafel & hummus plate", calories: 470, protein: 18, carbs: 52, fats: 22, servingSize: "1 plate", types: ["vegetarian", "vegan", "eggetarian", "non_vegetarian"] },
    { name: "Pad Thai (tofu)", calories: 380, protein: 18, carbs: 52, fats: 12, servingSize: "1 plate", types: ["vegetarian", "vegan", "eggetarian", "non_vegetarian"] },
    { name: "Chicken Caesar salad", calories: 420, protein: 36, carbs: 16, fats: 24, servingSize: "1 bowl", types: ["non_vegetarian"] },
    { name: "Burrito bowl (beef)", calories: 550, protein: 32, carbs: 55, fats: 22, servingSize: "1 bowl", types: ["non_vegetarian"] },
    { name: "Veggie burrito bowl", calories: 420, protein: 16, carbs: 60, fats: 12, servingSize: "1 bowl", types: ["vegetarian", "vegan", "eggetarian", "non_vegetarian"] },
    { name: "Miso soup & sushi (6 pcs)", calories: 340, protein: 18, carbs: 48, fats: 7, servingSize: "1 set", types: ["non_vegetarian"] },
    { name: "Minestrone soup & focaccia", calories: 330, protein: 12, carbs: 50, fats: 8, servingSize: "1 bowl + bread", types: ["vegetarian", "vegan", "eggetarian", "non_vegetarian"] },
    { name: "Palak paneer & roti", calories: 400, protein: 18, carbs: 38, fats: 20, servingSize: "1 plate", types: ["vegetarian", "eggetarian", "non_vegetarian"] },
    { name: "Aloo gobi & roti", calories: 340, protein: 10, carbs: 52, fats: 12, servingSize: "1 plate", types: ["vegetarian", "vegan", "eggetarian", "non_vegetarian"] },
  ],
  dinner: [
    ...
    { name: "Stir-fried tofu & noodles", calories: 380, protein: 20, carbs: 48, fats: 12, servingSize: "1 bowl", types: ["vegetarian", "vegan", "eggetarian", "non_vegetarian"] },
    { name: "Beef steak & salad", calories: 480, protein: 52, carbs: 10, fats: 22, servingSize: "1 plate", types: ["non_vegetarian"] },
    { name: "Paneer palak & jeera rice", calories: 420, protein: 20, carbs: 50, fats: 14, servingSize: "1 plate", types: ["vegetarian", "eggetarian", "non_vegetarian"] },
    { name: "Grilled shrimp & quinoa", calories: 370, protein: 38, carbs: 35, fats: 8, servingSize: "1 plate", types: ["non_vegetarian"] },
    { name: "Tandoori chicken & roti", calories: 400, protein: 36, carbs: 28, fats: 14, servingSize: "1 plate", types: ["non_vegetarian"] },
    { name: "Mutton curry & rice", calories: 520, protein: 32, carbs: 52, fats: 20, servingSize: "1 plate", types: ["non_vegetarian"] },
    { name: "Kadai paneer & naan", calories: 480, protein: 20, carbs: 50, fats: 24, servingSize: "1 plate", types: ["vegetarian", "eggetarian", "non_vegetarian"] },
    { name: "Dal makhani & butter naan", calories: 500, protein: 18, carbs: 70, fats: 18, servingSize: "1 plate", types: ["vegetarian", "eggetarian", "non_vegetarian"] },
    { name: "Chicken teriyaki & rice", calories: 460, protein: 36, carbs: 52, fats: 12, servingSize: "1 plate", types: ["non_vegetarian"] },
    { name: "Ramen (chicken)", calories: 430, protein: 22, carbs: 58, fats: 12, servingSize: "1 bowl", types: ["non_vegetarian"] },
    { name: "Spaghetti bolognese", calories: 520, protein: 26, carbs: 58, fats: 18, servingSize: "1 plate", types: ["non_vegetarian"] },
    { name: "Pasta arrabbiata", calories: 380, protein: 12, carbs: 65, fats: 8, servingSize: "1 plate", types: ["vegetarian", "vegan", "eggetarian", "non_vegetarian"] },
    { name: "Green curry with chicken", calories: 450, protein: 30, carbs: 30, fats: 26, servingSize: "1 plate", types: ["non_vegetarian"] },
    { name: "Tofu green curry & rice", calories: 380, protein: 16, carbs: 48, fats: 16, servingSize: "1 plate", types: ["vegetarian", "vegan", "eggetarian", "non_vegetarian"] },
    { name: "Mediterranean grilled fish", calories: 360, protein: 38, carbs: 14, fats: 16, servingSize: "1 plate", types: ["non_vegetarian"] },
    { name: "Couscous with roasted veggies", calories: 340, protein: 10, carbs: 56, fats: 8, servingSize: "1 plate", types: ["vegetarian", "vegan", "eggetarian", "non_vegetarian"] },
    { name: "Mushroom risotto", calories: 380, protein: 10, carbs: 58, fats: 14, servingSize: "1 bowl", types: ["vegetarian", "eggetarian", "non_vegetarian"] },
    { name: "Matar paneer & roti", calories: 420, protein: 18, carbs: 44, fats: 20, servingSize: "1 plate", types: ["vegetarian", "eggetarian", "non_vegetarian"] },
    { name: "Fish curry & rice", calories: 440, protein: 30, carbs: 50, fats: 12, servingSize: "1 plate", types: ["non_vegetarian"] },
    { name: "Kebab platter & pita", calories: 480, protein: 34, carbs: 40, fats: 20, servingSize: "1 plate", types: ["non_vegetarian"] },
  ],
  snack: [
    ...
    { name: "Dhokla", calories: 130, protein: 6, carbs: 22, fats: 3, servingSize: "4 pieces", types: ["vegetarian", "vegan", "eggetarian", "non_vegetarian"] },
    { name: "Masala chai & biscuits", calories: 160, protein: 4, carbs: 26, fats: 5, servingSize: "1 cup + 2 biscuits", types: ["vegetarian", "eggetarian", "non_vegetarian"] },
    { name: "Roasted peanuts", calories: 180, protein: 8, carbs: 6, fats: 15, servingSize: "40g", types: ["vegetarian", "vegan", "eggetarian", "non_vegetarian"] },
    { name: "Buttermilk (chaas)", calories: 60, protein: 4, carbs: 6, fats: 2, servingSize: "1 glass", types: ["vegetarian", "eggetarian", "non_vegetarian"] },
    { name: "Lassi (sweet)", calories: 180, protein: 7, carbs: 32, fats: 3, servingSize: "1 glass", types: ["vegetarian", "eggetarian", "non_vegetarian"] },
    { name: "Edamame", calories: 120, protein: 11, carbs: 10, fats: 5, servingSize: "1 cup", types: ["vegetarian", "vegan", "eggetarian", "non_vegetarian"] },
    { name: "Apple with almond butter", calories: 200, protein: 4, carbs: 28, fats: 9, servingSize: "1 apple + 1 tbsp", types: ["vegetarian", "vegan", "eggetarian", "non_vegetarian"] },
    { name: "Fruit chaat", calories: 130, protein: 2, carbs: 30, fats: 1, servingSize: "1 bowl", types: ["vegetarian", "vegan", "eggetarian", "non_vegetarian"] },
    { name: "Mango lassi", calories: 210, protein: 7, carbs: 40, fats: 3, servingSize: "1 glass", types: ["vegetarian", "eggetarian", "non_vegetarian"] },
    { name: "Guacamole & chips", calories: 260, protein: 3, carbs: 26, fats: 17, servingSize: "1 serving", types: ["vegetarian", "vegan", "eggetarian", "non_vegetarian"] },
    { name: "Protein bar", calories: 210, protein: 20, carbs: 22, fats: 7, servingSize: "1 bar", types: ["vegetarian", "eggetarian", "non_vegetarian"] },
  ],
};
